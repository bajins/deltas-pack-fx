...
/**
 * 多选日期
 * https://stackoverflow.com/questions/27229168/selecting-a-period-or-a-date-using-one-javafx-8-datepicker
        ...
        this.datePicker.setDayCellFactory((DatePicker param) -> new DateCell() {
            ...
            public void updateItem(LocalDate item, boolean empty) {
                ...
                if (!selectedDates.isEmpty() && selectedDates.contains(item)) {
                    if (Objects.equals(item, selectedDates.toArray()[0]) || Objects.equals(item,
                            selectedDates.toArray()[selectedDates.size() - 1])) {
